                                        ...
                                        <span class="d-flex align-items-center">
                                            ...
                                            @if ($userImage)
                                                <img class="rounded-circle header-profile-user"
                                                     src="{{ asset('admin_asset/images/users/avatar-1.jpg') }}"
                                                     alt="Header Avatar">
                                            @else
    ...
    <div id="scrollbar" style="background-color: #363e61; padding: 5px;">
        <div class="container-fluid">
            <ul class="navbar-nav d-flex align-items-center" id="navbar-nav">
                    ...
                    <a href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false"
                       class="d-flex align-items-center">
                        <i class="ri-list-check" style="color: white;"></i> <span data-key="t-dashboards"
                                                                                  class="category">All Categories</span>
                        <i class="ri-arrow-down-s-fill fs-22"
                           style="color: white;"></i>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            @foreach ($categories as $category)
                                <li class="nav-item">
                                    <a href="{{ route('lists', [$category->category_slug]) }}" class="nav-link"
                ...
                <li class="nav-item" style="padding: 10px;">
                    <a href="#" data-bs-toggle="collapse" role="button" aria-expanded="false"
